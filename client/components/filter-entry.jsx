          ...
          <div className='modal-container'>
            <div className="modal-wrapper">
              ...
              <div className="modal-body">
                <img onClick={this.handleClick} className="mood-modal" src="images/moods/laugh-beam-regular.svg" alt="laugh" />
                <img onClick={this.handleClick} className="mood-modal" src="images/moods/smile-regular.svg" alt="smile" />
                <img onClick={this.handleClick} className="mood-modal" src="images/moods/meh-regular.svg" alt="meh" />
                <img onClick={this.handleClick} className="mood-modal" src="images/moods/frown-regular.svg" alt="frown" />
                <img onClick={this.handleClick} className="mood-modal" src="images/moods/angry-regular.svg" alt="angry" />
              </div>
              <div className="modal-body">
                <h6>sun</h6>
                <h6>mon</h6>
